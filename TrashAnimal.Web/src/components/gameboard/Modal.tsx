  ...
  return createPortal(
    ...
    >
      <div
        ...
        className={`relative max-h-[85vh] overflow-y-auto rounded-[20px] border p-6 phone-landscape:max-h-[95vh] phone-landscape:p-4 ${fitContent ? 'w-fit' : 'w-full'} ${widthClassName}`}
        style={{
